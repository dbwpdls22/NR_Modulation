...
**STLC 구현을 위한 Frame Structure 설계** 
...
**STLC 구현을 위한 RF state handler 설계** 
...
→  vThread_RF.c에서 define된 VRF_IQSENDMARGIN과 VRF_MINSCHEDTIME에 따라 vrf_IQSendMargin 과  vrf_SchedTimeSample에 해당하는 sample 개수  결정 
